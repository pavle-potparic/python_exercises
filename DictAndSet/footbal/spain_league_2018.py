...
TEAMS = "spain_clubs_2018.json"
MATCHES = "spain_matches_2018.json"
FINAL_TABLE_FILE = 'spain_final_table_2018.json'


football.write_final_table(TEAMS, MATCHES, FINAL_TABLE_FILE)
